        ...
        if (activeFilter === 'All') {
            ...
            const filtered = projects.filter(project => {
                ...
                if (activeFilter === 'Ongoing') {
                    return status.includes('ongoing') || status.includes('on going');
                } else if (activeFilter === 'Completed') {
                    return status.includes('completed') || status.includes('done');
                } else if (activeFilter === 'Active') {
                    return status.includes('in_progress') || status.includes('pending');
                }
                    ...
                    <div className="projects-grid">
                        {filteredProjects.map((project) => (
                            <div className="project-card" key={project.id}>
                                ...
                                {/* View Details button commented out as requested
